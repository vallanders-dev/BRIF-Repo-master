...
// School supply lists — sourced from 16 school-issued PDFs (one per class,
// covering both programmes together). Kept in French only for now, same as
// received: item names and textbook citations are exact stationery/book
// terms, and getting a translation subtly wrong is worse than not having
// one yet. classLabel is the one exception — it pairs the class's English
// and French names exactly as BRIF's own curriculum tables already do
// (these are two real names for the same class, not a translation of each
// other), so it displays the same regardless of site language.
//
// "Protège document en plastique A4, 40 feuilles" is identical (same
// wording, same qty) across every class that has a published stationery
// list, so it's hoisted out here once instead of repeated 13 times.
export const supplyCommonItem = { qty: '1', name: 'Protège document en plastique A4, 40 feuilles' };

// stage: 'nursery' | 'primary' | 'secondary1' | 'secondary2' — matches the
// four groupings the index page displays.
// suppliesPending: true means the school has not yet published a stationery
// list for that class (true for the three upper-cycle lycée classes as of
// this data's source PDFs) — shown honestly on the page, not filled in.
export const supplyLists = [
  {
    key: 'pre-nursery',
    routeKey: 'suppliesPreNursery',
    stage: 'nursery',
    classLabel: 'Pre-Nursery · Prématernelle',
    items: [
      { qty: '1', name: 'Cartable en plastique' },
      { qty: '2', name: 'Cahiers de 100 pages' },
      { qty: '2', name: 'Protèges cahiers (rouge et vert)' },
      { qty: '1', name: 'Paquet de crayons de couleur pastel (marque Milan, Maped ou Bic)' },
      { qty: '1', name: 'Paquet de feutres (marque Milan, Maped ou Bic)' },
      { qty: '1', name: 'Paquet de papier A4 Paperline 2000, 80 gsm' },
      { qty: '1', name: 'TROUSSE contenant : bic bleu, bic rouge, taille-crayon, gomme, crayons à papier HB' },
      { qty: '1', name: 'Pot de colle forte 500ml (Top Bond)' },
      { qty: '2', name: 'Rouleaux de papier affiche (différentes couleurs)' },
      { qty: '2', name: 'Rouleaux de papier crépon (différentes couleurs)' },
      { qty: '2', name: 'Omo (détergent)' },
      { qty: '3', name: 'Pains de savon Viva' },
      { qty: '6', name: 'Papiers hygiéniques' },
      { qty: '1', name: 'Sacoche (une petite serviette blanche et une tenue de rechange)' },
    ],
    textbooks: {
      note: null,
      groups: [
        { subject: 'Manuels français', items: [
          'Coloriage à la Maternelle I & II — Collection Bel Avenir',
          'Graphisme – Écriture et Communication orale à la Maternelle (Petite section) — Collection Bel Avenir',
          'Pré-Mathématique à la Maternelle (Petite section) — Collection Bel Avenir',
          'Tout le programme à la Maternelle (Petite section) — Collection Magnard',
        ] },
        { subject: 'Manuels anglais', items: [], note: 'Voir le secrétariat de l’école' },
      ],
    },
  },
  {
    key: 'nursery-1',
    routeKey: 'suppliesNursery1',
    stage: 'nursery',
    classLabel: 'Nursery I · Maternelle I',
    items: [
      { qty: '1', name: 'Cahier TP A4, 100 pages' },
      { qty: '1', name: 'Protège cahier plastique A4 (rouge pour les filles et bleu pour les garçons)' },
      { qty: '1', name: 'Cartable en plastique' },
      { qty: '2', name: 'Cahiers de 100 pages' },
      { qty: '2', name: 'Protèges cahiers (jaune et bleu)' },
      { qty: '1', name: 'Paquet de papier canson couleur' },
      { qty: '1', name: 'Paquet de papier canson blanc' },
      { qty: '1', name: 'Paquet de crayons de couleur pastel (marque Milan, Maped ou Bic)' },
      { qty: '1', name: 'Paquet de feutres bout large (marque Milan, Maped ou Bic)' },
      { qty: '1', name: 'Paquet de gouache (10 couleurs)' },
      { qty: '1', name: 'Paquet de papier A4 Paperline 2000, 80 gsm' },
      { qty: '1', name: 'Ardoise à bordure plastique + chiffon' },
      { qty: '1', name: 'Paquet de craie blanche' },
      { qty: '1', name: 'Boîte de craie blanche' },
      { qty: '1', name: 'TROUSSE contenant : bics bleus, bic rouge, taille-crayon, gomme, règle graduée 30cm, pinceau N°8, paire de ciseaux à bout rond, crayons à papier HB' },
      { qty: '1', name: 'Pot de colle forte 500ml (Top Bond)' },
      { qty: '1', name: 'Rouleau de papier affiche' },
      { qty: '1', name: 'Rouleau de papier crépon' },
      { qty: '3', name: 'Omo (détergent)' },
      { qty: '3', name: 'Pains de savon Viva' },
      { qty: '6', name: 'Papiers hygiéniques' },
      { qty: '1', name: 'Sacoche (une petite serviette blanche/mouchoir et une tenue de rechange)' },
    ],
    textbooks: {
      note: null,
      groups: [
        { subject: 'Manuels français', items: [
          'Coloriage à la Maternelle I & II — Collection Bel Avenir',
          'Graphisme – Écriture et Communication orale à la Maternelle (Section des grands) — Collection Bel Avenir',
          'Dessin à la Maternelle I & II — Collection Bel Avenir',
          'Pré-Mathématique à la Maternelle (Section des grands) — Collection Bel Avenir',
          'Réussir ma maternelle, Livre 1 & 2, Petite section (Yaslo)',
          'Mathématique, Petite section — Collection Petits Génies',
          'Graphilettre MS-GS — Collection Magnard',
        ] },
        { subject: 'Manuels anglais', items: [], note: 'Voir le secrétariat de l’école' },
      ],
    },
  ...
  {
    key: 'nursery-2',
    routeKey: 'suppliesNursery2',
    stage: 'nursery',
    classLabel: 'Nursery II · Maternelle II',
    items: [
      { qty: '1', name: 'Cahier TP A4, 100 pages' },
      { qty: '1', name: 'Protège cahier plastique A4 (rouge pour les filles et bleu pour les garçons)' },
      { qty: '1', name: 'Cartable en plastique' },
      { qty: '2', name: 'Cahiers de 100 pages' },
      { qty: '2', name: 'Protèges cahiers (vert et rouge)' },
      { qty: '1', name: 'Paquet de papier canson couleur' },
      { qty: '1', name: 'Paquet de papier canson blanc' },
      { qty: '1', name: 'Paquet de crayons de couleur pastel (marque Milan, Bic ou Maped)' },
      { qty: '1', name: 'Paquet de feutres bout fin (marque Milan, Bic ou Maped)' },
      { qty: '1', name: 'Paquet d’aquarelle (12 couleurs)' },
      { qty: '3', name: 'Paquets de papier A4 Paperline 2000, 80 gsm' },
      { qty: '1', name: 'Ardoise à bordure plastique + chiffon' },
      { qty: '1', name: 'Boîte de craie blanche' },
      { qty: '1', name: 'TROUSSE contenant : bics bleus, bic rouge, taille-crayon, gommes, règle graduée 30cm, pinceau N°8, paire de ciseaux à bout rond, crayons à papier HB' },
      { qty: '1', name: 'Pot de colle forte 500ml (Top Bond)' },
      { qty: '2', name: 'Rouleaux de papier affiche (différentes couleurs)' },
      { qty: '2', name: 'Rouleaux de papier crépon (différentes couleurs)' },
      { qty: '3', name: 'Omo (détergent)' },
      { qty: '3', name: 'Pains de savon Viva' },
      { qty: '6', name: 'Rouleaux de papier hygiénique' },
      { qty: '1', name: 'Sacoche (une petite serviette blanche/mouchoir et une tenue de rechange)' },
    ],
    textbooks: {
      note: null,
      groups: [
        { subject: 'Manuels français', items: [
          'Prélecture à la Maternelle (Section des grands) — Collection Bel Avenir',
          'Réussir ma maternelle, Livre 1 & 2, Section des grands (Yaslo)',
          'Je lis mes premiers mots — Collection Hachette',
          'Mathématique, Moyenne et grande sections — Collection Hachette',
          'Toute la maternelle Lecture, Moyenne section — NEI CEDA édition',
          'Graphilettre MS-GS — Collection Magnard',
        ] },
        { subject: 'Manuels anglais', items: [], note: 'Voir le secrétariat de l’école' },
      ],
  ...
  {
    key: 'cp1',
    routeKey: 'suppliesCp1',
    stage: 'primary',
    classLabel: 'Year 1 · CP1',
    items: [
      { qty: '2', name: 'Le décodable : Lecture et activités CP' },
      { qty: '2', name: 'Le décodable : Mathématique et activités CP' },
      { qty: '1', name: 'Manuel : Langage lecture CP1 — Collection Le Flamboyant' },
      { qty: '1', name: 'Cahier d’écriture et d’évaluation au CI — Collection clé du succès' },
      { qty: '1', name: 'Nouveau syllabaire CI-CP-CE1' },
      { qty: '1', name: 'Cahier d’écriture' },
      { qty: '1', name: 'Cahier de dessin ordinaire' },
      { qty: '2', name: 'Cahiers de 200 pages cartonnés' },
      { qty: '3', name: 'Cahiers de 100 pages Calligraphe' },
      { qty: '1', name: 'Ardoise' },
      { qty: '1', name: 'Chiffon' },
      { qty: '1', name: 'TROUSSE contenant : 2 bics bleus, 2 bics rouges, taille-crayon, 2 gommes, règle graduée 30cm, 2 crayons à papier HB, marqueur noir, boîte de craie blanche' },
      { qty: '1', name: 'Paquet de pipette' },
      { qty: '1', name: 'Boîte de crayons de couleur (12)' },
      { qty: '4', name: 'Rouleaux de couverture kaki' },
      { qty: '1', name: 'Pot de colle blanche (Top Bond)' },
      { qty: '4', name: 'Protège-cahiers (rouge, vert, bleu, jaune)' },
      { qty: '1', name: 'Sac d’écolier' },
      { qty: '2', name: 'Sachets de savon OMO' },
      { qty: '1', name: 'Petite serviette blanche (mouchoir)' },
      { qty: '2', name: 'Papiers affiches' },
      { qty: '3', name: 'Paquets de papier A4 Paperline 2000' },
    ],
    textbooks: {
      note: 'Les manuels d’accompagnement français : voir le secrétariat de l’école. Les livres d’anglais sont disponibles à l’école ; le prix par classe est mentionné sur la fiche de renseignement de l’école.',
      groups: [],
    },
  },
  {
    key: 'cp2',
    routeKey: 'suppliesCp2',
    stage: 'primary',
    classLabel: 'Year 2 · CP2',
    items: [
      { qty: '2', name: 'Le décodable : Lecture et activités CP' },
      { qty: '2', name: 'Le décodable : Mathématique et activités CP' },
      { qty: '1', name: 'Manuel : Langage lecture CP2 — Collection Le Flamboyant' },
      { qty: '1', name: 'Cahier d’écriture et d’évaluation au CP — Collection clé du succès' },
      { qty: '1', name: 'Nouveau syllabaire CI-CP-CE1' },
      { qty: '1', name: 'Cahier d’écriture' },
      { qty: '1', name: 'Cahier de dessin ordinaire' },
      { qty: '2', name: 'Cahiers de 200 pages cartonnés' },
  ...
  {
    key: 'ce1',
    routeKey: 'suppliesCe1',
    stage: 'primary',
    classLabel: 'Year 3 · CE1',
    items: [
      { qty: '1', name: 'Manuel de français CE1' },
      { qty: '1', name: 'Manuel de mathématique CE1' },
      { qty: '1', name: 'Nouveau syllabaire' },
      { qty: '4', name: 'Cahiers de 200 pages bien cartonnés' },
      { qty: '1', name: 'Cahier de dessin ordinaire' },
      { qty: '5', name: 'Cahiers de 100 pages Calligraphe' },
      { qty: '2', name: 'Cahiers de TP grand format' },
      { qty: '1', name: 'Ardoise grand format' },
      { qty: '1', name: 'Chiffon' },
      { qty: '1', name: 'TROUSSE contenant : 2 bics bleus, 2 bics rouges, 2 bics verts, taille-crayon, 2 gommes, règle graduée 30cm, 2 crayons à papier HB, marqueur noir, boîte de craie blanche' },
      { qty: '1', name: 'Vrai dessinateur' },
      { qty: '1', name: 'Boîte de couture' },
      { qty: '1', name: 'Boîte de 12 crayons de couleur' },
      { qty: '4', name: 'Rouleaux de couverture kaki' },
      { qty: '1', name: 'Pot de colle blanche Top Bond 500ml' },
      { qty: '4', name: 'Protège-cahiers (rouge, vert, bleu, jaune)' },
      { qty: '1', name: 'Sac d’écolier' },
      { qty: '2', name: 'Sachets de savon OMO (500g)' },
      { qty: '1', name: 'Petite serviette blanche (mouchoir)' },
      { qty: '6', name: 'Rouleaux de papier hygiénique' },
      { qty: '2', name: 'Papiers affiches' },
      { qty: '3', name: 'Paquets de papier A4 Paperline 2000' },
  ...
  {
    key: 'ce2',
    routeKey: 'suppliesCe2',
    stage: 'primary',
    classLabel: 'Year 4 · CE2',
    items: [
      { qty: '1', name: 'Manuel de français CE2' },
      { qty: '1', name: 'Manuel de mathématique CE2' },
      { qty: '1', name: 'Nouveau syllabaire' },
      { qty: '4', name: 'Cahiers de 200 pages bien cartonnés' },
      { qty: '1', name: 'Cahier de dessin ordinaire' },
      { qty: '5', name: 'Cahiers de 100 pages Calligraphe' },
      ...
      { qty: '1', name: 'Ardoise grand format' },
      { qty: '1', name: 'Chiffon' },
      { qty: '1', name: 'TROUSSE contenant : 2 bics bleus, 2 bics rouges, 2 bics verts, taille-crayon, 2 gommes, règle graduée 30cm, 3 crayons à papier HB, marqueur noir, boîte de craie blanche' },
      { qty: '1', name: 'Vrai dessinateur' },
      { qty: '1', name: 'Boîte de couture' },
      { qty: '1', name: 'Boîte de 12 crayons de couleur' },
      { qty: '4', name: 'Rouleaux de couverture kaki' },
  ...
  {
    key: 'cm1',
    routeKey: 'suppliesCm1',
    stage: 'primary',
    classLabel: 'Year 5 · CM1',
    items: [
      { qty: '1', name: 'Manuel de français CM1' },
      { qty: '1', name: 'Manuel de mathématique CM1' },
      { qty: '1', name: 'Annale corrigée CM1 — Collection Label Info' },
      { qty: '1', name: 'Art de conjuguer' },
      { qty: '3', name: 'Cahiers de 200 pages bien cartonnés' },
      { qty: '1', name: 'Cahier de 300 pages cartonné' },
      { qty: '1', name: 'Cahier de dessin ordinaire' },
      { qty: '7', name: 'Cahiers de 100 pages Calligraphe' },
      { qty: '1', name: 'Cahier de TP grand format' },
      { qty: '1', name: 'Ardoise grand format' },
      { qty: '1', name: 'Chiffon' },
      { qty: '1', name: 'TROUSSE contenant : 2 bics bleus, 2 bics rouges, 2 bics verts, taille-crayon, 2 gommes, règle graduée 30cm, 2 crayons à papier HB, marqueur noir, boîte de craie blanche' },
      { qty: '1', name: 'Vrai dessinateur' },
      ...
      { qty: '4', name: 'Rouleaux de couverture kaki' },
      { qty: '1', name: 'Pot de colle blanche (Top Bond)' },
      { qty: '4', name: 'Protège-cahiers (rouge, vert, jaune, bleu)' },
      { qty: '1', name: 'Sac d’écolier' },
      { qty: '2', name: 'Savons OMO' },
      { qty: '6', name: 'Rouleaux de papier hygiénique' },
      { qty: '1', name: 'Petite serviette blanche (mouchoir)' },
      { qty: '2', name: 'Papiers affiches' },
      { qty: '3', name: 'Paquets de papier A4 Paperline 2000' },
  ...
  {
    key: 'cm2',
    routeKey: 'suppliesCm2',
    stage: 'primary',
    classLabel: 'Year 6 · CM2',
    items: [
      { qty: '1', name: 'Manuel de français CM2' },
      { qty: '1', name: 'Manuel de mathématique CM2' },
      { qty: '1', name: 'Annale corrigée CM2 — Collection Label Info' },
      { qty: '1', name: 'Art de conjuguer' },
      { qty: '3', name: 'Cahiers de 200 pages bien cartonnés' },
      { qty: '1', name: 'Cahier de 300 pages bien cartonné' },
      { qty: '1', name: 'Cahier de dessin ordinaire' },
      { qty: '7', name: 'Cahiers de 100 pages Calligraphe' },
      { qty: '1', name: 'Cahier de TP grand format' },
      { qty: '1', name: 'Ardoise grand format' },
      { qty: '1', name: 'Chiffon' },
      { qty: '1', name: 'TROUSSE contenant : 2 bics bleus, 2 bics rouges, 2 bics verts, 2 crayons à papier HB, règle graduée, gomme, taille-crayon, boîte de craie blanche' },
      { qty: '1', name: 'Vrai dessinateur' },
      { qty: '1', name: 'Boîte de couture' },
      { qty: '1', name: 'Boîte de 12 crayons de couleur' },
      { qty: '4', name: 'Rouleaux de couverture kaki' },
      { qty: '2', name: 'Pots de colle blanche' },
      { qty: '4', name: 'Protège-cahiers (rouge, vert, jaune, bleu)' },
      { qty: '6', name: 'Rouleaux de papier hygiénique' },
      { qty: '1', name: 'Sac d’écolier' },
      { qty: '2', name: 'Savons OMO' },
  ...
  },
  {
    ...
    routeKey: 'supplies6e',
    stage: 'secondary1',
    classLabel: 'Year 7 · 6è',
    items: [
      { qty: '5', name: 'Cahiers de 200 pages cartonnés' },
      { qty: '10', name: 'Cahiers de 100 pages Calligraphe' },
      { qty: '1', name: 'Cahier TP de 100 pages' },
      { qty: '1', name: 'Vrai dessinateur' },
      { qty: '1', name: 'Trousse (bics, crayons, gomme, règle plate, …)' },
      { qty: '3', name: 'Paquets de papier rame A4 Paperline' },
    ],
    textbooks: {
      note: null,
      groups: [
        { subject: 'Français', items: ['Mama Raouf, Pourquoi le bouc sent mauvais et autres contes du Bénin, LAHA Éditions (pour la classe de 6è)'] },
        { subject: 'Anglais', items: ['The New English Students 6è'] },
        { subject: 'Histoire-Géographie', items: ['Document d’accompagnement — Réussir en Histoire et Géographie 6è'] },
        { subject: 'PCT', items: ['Réussir en PCT 6è'] },
        { subject: 'Mathématiques', items: ['Réussir en Mathématiques, Livre du professeur — LAHA Éditions', 'Mathématique — Collection Réussir en mathématiques 6è, LAHA Éditions'] },
        { subject: 'SVT', items: ['Document d’accompagnement de SVT — Collection Réussir en SVT 6è'] },
        { subject: 'Espagnol', items: ['Horizontes 4è'] },
      ],
    },
  },
  {
    ...
    routeKey: 'supplies5e',
    stage: 'secondary1',
    classLabel: 'Year 8 · 5è',
    items: [
      { qty: '5', name: 'Cahiers de 200 pages cartonnés (pour le cours)' },
      { qty: '10', name: 'Cahiers de 100 pages Calligraphe (pour les exercices et recherches)' },
      { qty: '1', name: 'Cahier TP de 100 pages' },
      { qty: '1', name: 'Vrai dessinateur' },
      { qty: '1', name: 'Trousse (bics, crayons, gomme, règle plate, …)' },
      { qty: '3', name: 'Paquets de papier rame A4 Paperline' },
    ...
    textbooks: {
      note: null,
      groups: [
        { subject: 'Français', items: ['FASSINOU Adélaïde (2014), Yèmi ou le Miracle de l’amour, Star Éditions'] },
        { subject: 'Anglais', items: ['The New English Students 5è'] },
        { subject: 'Histoire-Géographie', items: ['Document d’accompagnement — Réussir en Histoire et Géographie 5è'] },
        { subject: 'PCT', items: ['Lumière 5è'] },
        { subject: 'Mathématiques', items: ['Réussir en Mathématiques, Livre du professeur — LAHA Éditions', 'Mathématique — Collection Réussir en mathématiques 5è, LAHA Éditions'] },
        { subject: 'SVT', items: ['Document d’accompagnement de SVT — Collection Réussir en SVT 5è'] },
        { subject: 'Espagnol', items: ['Horizontes 4è'] },
      ],
    },
  },
  {
    ...
    textbooks: {
      note: null,
      groups: [
        { subject: 'Français', items: ['PLIYA Jean (1973), La secrétaire particulière, Éditions CLE (pour la classe de 4è)'] },
        { subject: 'Anglais', items: ['The New English Students 4è'] },
        { subject: 'Histoire-Géographie', items: ['Document d’accompagnement — Réussir en Histoire et Géographie 4è'] },
        { subject: 'PCT', items: ['Lumière 4è'] },
        { subject: 'Mathématiques', items: ['Réussir en Mathématiques, Livre du professeur — LAHA Éditions', 'Mathématique — Collection Réussir en mathématiques 4è, LAHA Éditions'] },
        { subject: 'SVT', items: ['Document d’accompagnement de SVT — Collection Réussir en SVT 4è'] },
        { subject: 'Espagnol', items: ['Horizontes 4è'] },
      ],
    },
  },
  {
    ...
    routeKey: 'supplies3e',
    stage: 'secondary1',
    classLabel: 'Year 10 · 3è',
    items: [
      { qty: '4', name: 'Cahiers de 300 pages cartonnés' },
      { qty: '5', name: 'Cahiers de 200 pages cartonnés' },
      { qty: '5', name: 'Cahiers de 100 pages Calligraphe' },
      { qty: '1', name: 'Cahier TP de 100 pages' },
      { qty: '1', name: 'Vrai dessinateur' },
    ...
    textbooks: {
      note: null,
      groups: [
        { subject: 'Français', items: ['PRUDENCIO A. Eustache (2018), Le mortier rouge, Les Éditions du Flamboyant', 'LALEYE Abdel Hakim A., Serment d’abstinence, LAHA Éditions'] },
        { subject: 'Anglais', items: ['The New English Students 3è'] },
        { subject: 'Histoire-Géographie', items: ['Document d’accompagnement — Réussir en Histoire et Géographie 3è'] },
        { subject: 'PCT', items: ['Lumière 3è'] },
        { subject: 'Mathématiques', items: ['Réussir en Mathématiques, Livre du professeur — LAHA Éditions', 'Mathématique — Collection Réussir en mathématiques 3è, LAHA Éditions'] },
        { subject: 'SVT', items: ['Document d’accompagnement de SVT — Collection Réussir en SVT 3è'] },
        { subject: 'Espagnol', items: ['Horizontes 3è'] },
      ],
    },
  },
  {
    key: '2nde-cd',
    routeKey: 'supplies2ndeCd',
    stage: 'secondary2',
    classLabel: 'Year 11 · 2nde CD',
    ...
    textbooks: {
      note: null,
      groups: [
        { subject: 'Français', items: ['AGBAZAHOU Apollinaire (2012), Le gong a bégayé (théâtre), Éd. Plumes-Soleil'] },
        { subject: 'Philosophie', items: ['PLATON (1965), Apologie de Socrate, Criton, Phédon, Garnier/Flammarion'] },
        { subject: 'Anglais', items: ['MONTGOMERY Michael et al. (1994), Go for English 2nde, Macmillan/NEI Edicef'] },
        { subject: 'Histoire-Géographie', items: [
          'DOSSOU K.L.C.P. (2020), Réussir en Histoire-Géographie 2nde, Collection citoyenne, LAHA Éditions',
          'KI-ZERBO J. (1999), Histoire Générale de l’Afrique : Méthodologie et Préhistoire africaine, Tome I, UNESCO',
        ] },
        { subject: 'Mathématiques', items: [
          'AHOUANGBO Sylvain et al. (2022), Recueil d’épreuves « La Passion des Maths », 2ndes C et D, CT Imprimerie',
          'AGBOKOU Jules Clotaire (2008), Conquête de compétences mathématiques, 2nde C et D, Éditions SIAG',
        ] },
        { subject: 'SVT', items: ['da CONCEIÇÃO Yves (2021), Réussir en SVT, 2nde C ou D, Collection Citoyenne, LAHA Éditions'] },
        { subject: 'PCT', items: [
          'AGBO K. Hortense et al. (2012), Physique Chimie et Technologie, C, D et E, Collection Orange',
          'Document d’accompagnement — Collection l’Éveil',
        ] },
      ],
    },
  },
  {
    key: '1ere-cd',
    routeKey: 'supplies1ereCd',
    stage: 'secondary2',
    classLabel: 'Year 12 · 1ère CD',
    suppliesPending: true,
    items: [
      { qty: '3', name: 'Paquets de papier rame A4 Paperline' },
    ],
    textbooks: {
      note: null,
      groups: [
        { subject: 'Français', items: ['BARNABE-AKAYI Daté Atavito (2009), L’affaire Bissi, il y a mieux que la neige, Ruisseaux d’Afrique'] },
        { subject: 'Philosophie', items: [
          'Paulin J. HOUNTONDJI et al. (2019), Les savoirs endogènes, CODESRIA/Karthala',
          'ROUSSEAU Jean-Jacques (2010), Du Contrat Social, Nathan',
        ] },
        { subject: 'Anglais', items: ['MONTGOMERY Michael et al. (1994), Go for English 1ère, Macmillan/NEI Edicef'] },
        { subject: 'Histoire-Géographie', items: ['DOSSOU K.L.C.P. (2020), Réussir en Histoire-Géographie 1ère, Collection citoyenne, LAHA Éditions'] },
        { subject: 'Mathématiques', items: ['AGBOKOU Jules Clotaire (2010), Conquête de compétences mathématiques, 1ère CD, Éditions SIAG'] },
        { subject: 'SVT', items: ['da CONCEIÇÃO Yves (2021), Réussir en SVT, 1ère D, Collection Citoyenne, LAHA Éditions'] },
        { subject: 'PCT', items: ['Document d’accompagnement — Collection l’Éveil'] },
      ],
    },
  },
  {
    key: 'terminale-cd',
    routeKey: 'suppliesTerminaleCd',
    stage: 'secondary2',
    classLabel: 'Terminale CD',
    suppliesPending: true,
    items: [
      { qty: '3', name: 'Paquets de papier rame A4 Paperline' },
    ],
    textbooks: {
      note: null,
      groups: [
        { subject: 'Français', items: ['BIKOÏ Félix Nicodème et al. (2000), Le français en première et terminale, Éd. Edicef'] },
        { subject: 'Anglais', items: ['MONTGOMERY Michael et al. (1994), Go for English Terminale, Macmillan/NEI Edicef'] },
        { subject: 'Histoire-Géographie', items: ['DOSSOU K.L.C.P. (2020), Réussir en Histoire-Géographie Tle, Collection citoyenne, LAHA Éditions'] },
        { subject: 'Philosophie', items: ['BACHELARD Gaston (1993), La formation de l’esprit scientifique, Librairie philosophique J. Vrin'] },
        { subject: 'PCT', items: [
          'AGBO K. Hortense et al. (2012), Physique Chimie et Technologie, Terminales C, D et E, Collection Orange',
          'Collection l’Éveil',
        ] },
        { subject: 'Mathématiques', items: ['AGBOKOU Jules Clotaire (2010), Conquête de compétences mathématiques, Terminale C et D, Tome I, Éditions SIAG'] },
        { subject: 'SVT', items: ['de CONCEIÇÃO Yves (2022), Réussir en SVT, Collection Citoyenne, LAHA Éditions'] },
      ],
    },
  },
];
...
export const content = {
  en: {
    ...
    parentsSuppliesIndex: {
      kicker: 'For BRIF families',
      title: 'School Supply Lists',
      intro: 'Find your child’s class below for its full supply list. Item names are kept in French, as issued by the school, since supplies are bought locally. Open a class to view a clean, printable list, or print it straight from your phone at the market.',
      note: 'One item, a plastic A4 document protector (40 sheets), is needed for every class and is only listed once — see the notice on each class page.',
      stageLabels: {
        nursery: 'Nursery',
        primary: 'Primary',
        secondary1: 'Secondary — 1st Cycle',
        secondary2: 'Secondary — 2nd Cycle',
      },
      viewListLabel: 'View list',
      backToParents: 'Back to Parents',
    },
    parentsSuppliesClass: {
      kicker: 'School supply list',
      backToAllLists: 'Back to all supply lists',
      backToParents: 'Back to Parents',
      printButton: 'Print this list',
      itemsHeading: 'Supplies',
      checkColumnLabel: 'Got it',
      qtyColumnLabel: 'Qty',
      itemColumnLabel: 'Item',
      commonItemNote: 'Also needed, for every class:',
      textbooksHeading: 'Textbooks',
      pendingTitle: 'Not yet published',
      pendingText: 'The school has not yet published a stationery list for this class. It will be communicated by subject at the start of the school year.',
      officialLabel: 'Official document',
  ...
  fr: {
    ...
    parentsSuppliesIndex: {
      kicker: 'Pour les familles de la BRIF',
      title: 'Listes de fournitures scolaires',
      intro: 'Retrouvez ci-dessous la classe de votre enfant pour sa liste complète de fournitures. Les articles restent en français, tels que publiés par l’école, puisque les fournitures s’achètent sur place. Ouvrez une classe pour voir une liste claire et imprimable — ou imprimez-la directement depuis votre téléphone au marché.',
      note: 'Un article, le protège-document en plastique A4 (40 feuilles), est nécessaire pour toutes les classes et n’est indiqué qu’une seule fois — voir la mention sur chaque page de classe.',
      stageLabels: {
        nursery: 'Maternelle',
        primary: 'Primaire',
        secondary1: 'Secondaire — 1er Cycle',
        secondary2: 'Secondaire — 2nd Cycle',
      },
      viewListLabel: 'Voir la liste',
      backToParents: 'Retour à Parents',
    },
    parentsSuppliesClass: {
      kicker: 'Liste de fournitures scolaires',
      backToAllLists: 'Retour à toutes les listes',
      backToParents: 'Retour à Parents',
      printButton: 'Imprimer cette liste',
      itemsHeading: 'Fournitures',
      checkColumnLabel: 'Fait',
      qtyColumnLabel: 'Qté',
      itemColumnLabel: 'Article',
      commonItemNote: 'Également nécessaire, pour toutes les classes :',
      textbooksHeading: 'Manuels',
      pendingTitle: 'Pas encore publiée',
      pendingText: 'L’école n’a pas encore publié de liste de fournitures pour cette classe. Elle sera communiquée par matière à la rentrée.',
      officialLabel: 'Document officiel',
